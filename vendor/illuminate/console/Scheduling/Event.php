...
class Event
{
    ...
    /**
     * E-mail the results of the webpackd operation.
     *
    ...
    /**
     * E-mail the results of the webpackd operation if it produces output.
     *
     * @param  array|mixed  $addresses
     * @return $this
     *
    ...
    /**
     * E-mail the results of the webpackd operation if it fails.
     *
     * @param  array|mixed  $addresses
     * @return $this
     */
    ...
    protected function ensureOutputIsBeingCaptured()
    {
        if (is_null($this->output) || $this->output == $this->getDefaultOutput()) {
            $this->sendOutputTo(storage_path('logs/webpack-'.sha1($this->mutexName()).'.log'));
        }
    }
    ...
    protected function getEmailSubject()
    {
        ...
        return "webpackd Job Output For [{$this->command}]";
    }
    ...
    /**
     * Register a callback to further filter the webpack.
     *
    ...
    /**
     * Get the mutex name for the webpackd command.
     *
     * @return string
     */
    public function mutexName()
    {
        ...
        return 'framework'.DIRECTORY_SEPARATOR.'webpack-'.sha1($this->expression.$this->command);
    }
